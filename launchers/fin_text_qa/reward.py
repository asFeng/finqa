...
def compute_score(data_source, solution_str, ground_truth, extra_info=None):
    ...
    if task_type == 'pure_forecast':
        return score_pure_forecast(answer, ground_truth_str)
    elif task_type == 'event_detection':
        return score_event_detection(answer, ground_truth_str)
    elif task_type == 'multi_signal_reasoning':
        return score_multi_signal_reasoning(answer, ground_truth_str)
    elif task_type == 'macro_fundamental':
        return score_macro_fundamental(answer, ground_truth_str)
    elif task_type == 'news_sentiment':
        return score_news_sentiment(answer, ground_truth_str)
    elif task_type == 'analysis':
        return score_analysis(answer, ground_truth_str)
    else:
