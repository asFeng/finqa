#!/bin/bash
#
# Financial QA RL Training - Qwen3-8B Default Configuration
#
# Usage:
#   bash run_8b.sh [additional hydra overrides]
#
...
#
# Example:
#   USE_UNCERTAINTY=false ROLLOUT_N=12 bash run_8b.sh
#
...
EXP_NAME=${EXP_NAME:-"qwen3_8b_default"}
...
# === DATA (8B series) ===
TRAIN_FILE="$BASE_DIR/data/train_8b_model_forecast_20000.parquet"
...
echo "=============================================="
echo " Financial QA RL Training - Qwen3-8B"
echo "=============================================="
