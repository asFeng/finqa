#!/bin/bash
#
# Financial QA RL Training - Qwen3-8B with GROUNDTRUTH Data
#
# Usage:
#   bash run_gt_8b.sh [additional hydra overrides]
#
...
#
# Example:
#   USE_UNCERTAINTY=false ROLLOUT_N=12 bash run_gt_8b.sh
#
...
EXP_NAME=${EXP_NAME:-"qwen3_8b_gt_default"}
...
# === MODEL ===
MODEL_PATH="catherpker/stockr1-qwen3-8b"

# === DATA (8B series - GROUNDTRUTH) ===
TRAIN_FILE="$BASE_DIR/data/train_8b_groundtruth_20000.parquet"
TEST_FILE="$BASE_DIR/data/test_8b_model_forecast_2000.parquet"
...
#   - At ~120-150s/step ≈ 104-130 hours ≈ 4-5 days
#
...
echo "=============================================="
echo " Financial QA RL Training - Qwen3-8B (GT)"
echo "=============================================="
