#!/bin/bash
#
# Financial QA RL Training - Qwen3-4B with GROUNDTRUTH Data
#
# Usage:
#   bash run_gt_4b.sh [additional hydra overrides]
#
...
#
# Example:
#   USE_UNCERTAINTY=false ROLLOUT_N=12 bash run_gt_4b.sh
#
...
EXP_NAME=${EXP_NAME:-"qwen3_4b_gt_default"}
...
# === DATA (4B series - GROUNDTRUTH) ===
TRAIN_FILE="$BASE_DIR/data/train_4b_groundtruth_20000.parquet"
